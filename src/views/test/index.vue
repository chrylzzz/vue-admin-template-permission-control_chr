  ...
  <div class="app-container">
    ...
    <div>
      ...
      >
        ...
        <el-table-column fixed prop="releaseDate" label="交易日期" width="120" align="center"></el-table-column>
        <el-table-column prop="goodsName" label="账户名" width="100" align="center"></el-table-column>
        <el-table-column prop="goodsType" label="开户行" width="100" align="center"></el-table-column>
        <el-table-column prop="goodsColor" label="被代理账户名" width="100" align="center"></el-table-column>
        <el-table-column prop="goodsPrice" label="交易金额" width="100" align="center"></el-table-column>
        <el-table-column prop="goodsStatus" label="来往账标识" width="100" align="center"></el-table-column>
        <el-table-column prop="goodsStatus" label="工资发流水标识" width="100" align="center">
        ...
        <el-table-column prop="goodsStatus" label="结束标识" width="100" align="center">
          <!-- 判断使用 标签显示 -->
          <template slot-scope="{row}">
            <el-tag
        ...
        <el-table-column label="交易类型" width="100px">
          <!--  直接用disable禁用可编辑 -->
          <template slot-scope="{row}">
            <el-rate
