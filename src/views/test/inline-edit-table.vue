  ...
  <div class="app-container">
    <div>
      ...
      >
        ...
        <el-table-column prop="goodsName" label="账户名称" width="100" align="center"></el-table-column>
        <el-table-column prop="goodsType" label="收款方式" width="100" align="center"></el-table-column>
        <el-table-column prop="goodsColor" label="收款人账号" width="100" align="center"></el-table-column>
        <el-table-column prop="goodsPrice" label="代发金额" width="100" align="center"></el-table-column>
        <el-table-column prop="goodsStatus" label="代发状态" width="100" align="center">
          <!-- 判断使用 标签显示 -->
        ...
        <!--------------------------------------------------------------------------------------------->
        <el-table-column min-width="20px" label="描述" align="center">
          <template slot-scope="{row}">
